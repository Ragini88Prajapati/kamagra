    ...
    <div class="menu_custom  row">
        <div id="column-left" class="col-sm-3 col-md-3 col-lg-3 hidden-xs d-none d-lg-block">
            ...
            <div class="bt-staticblock-college d-none">
                ...
                <div class="text-info"> <span class="small-text text-1">College bound?</span> <span
                        class="large-text">Save 15%</span> <span class="small-text text-2">There are many
                        ...
                        <div id="boss_testimonial_0">
                            ...
                            <div class="testimonial-item">
                                <div class="testimonial-image"> <img alt="author"
                                        src="{{asset('/assets/images/blogs/').'/'.$item->image_name}}" /> </div>
                                <div class="testimonial-message">
                                    <p>{{ isset($item->short_description) &&  !empty($item->short_description) ? $item->short_description  :  '' }}<a
                                            href="#" title="More...">...</a>
                                    </p>
                                </div>
                                <div class="testimonial-name">
                                    {{ isset($item->name) &&  !empty($item->name) ? $item->name  :  '' }} </div>
                            </div>
                            @empty
            ...
            <div class="bt-box box-special advertisment-div">
                ...
                <div class="box-content">
                    <div class="list-product" id="product_special_0">
                        ...
                        <div class="item product-thumb">
                            <div class="image text-center">
                                <a href="">
                                    <img src="{{$static->ad_image1!=''? asset('/assets/images/static/').'/'.$static->ad_image1:''}}"
                                        alt="Kamagra">
                                </a>
                            </div>
                        </div><!-- /.item -->
                        ...
                        <div class="item product-thumb">
                            <div class="image text-center">
                                <a href="">
                                    <img src="{{$static->ad_image2!=''? asset('/assets/images/static/').'/'.$static->ad_image2:''}}"
                                        alt="Kamagra">
                                </a>
                            </div>
                        </div><!-- /.item -->
                        ...
                        <div class="item product-thumb">
                            <div class="image text-center">
                                <a href="">
                                    <img src="{{$static->ad_image3!=''? asset('/assets/images/static/').'/'.$static->ad_image3:''}}"
                                        alt="Kamagra">
                                </a>
                            </div>
                        </div><!-- /.item -->
                    ...
                    <div class="carousel-button"> <a id="prev_special_0" class="prev nav_thumb"
                            href="javascript:void(0)" title="prev"><i class="fa fa-angle-left"></i></a> <a
                            id="next_special_0" class="next nav_thumb" href="javascript:void(0)" title="next"><i
                    ...
                    <div id="tabs_content_container0" class="home_filter_content tabs_content_container">
                        ...
                        <div class="box-content">
                            <div id="content_tab00" class="content_tabs0 list_carousel responsive column-noimage"
                                style="display:block">
                                <ul id="carousel_tab00" data-prev="#prev_tab00" data-next="#next_tab00"
                                    class="box-product">
                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="product-thumb">
                                            <div class="image">
                                                <a class="" data-id="42" href="product-detail.php"><img
                                                        src="images/product/p2-81x81.jpg" alt="Baby Bottle"
                                                        title="Baby Bottle" />
                                                </a>
                                            </div>
                                                ...
                                                <div class="button-group">
                                                    ...
                                                    <div class="wishlist-compare">
                                                        <button class="btn-wishlist" type="button"
                                                            title="Add to Wish List"><i class="fa fa-heart"></i>
                                                        </button>
                                                        <button class="btn-compare" type="button"
                                                            title="Compare this Product"><i class="fa fa-retweet"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="box_btn_icon">
                                                ...
                                                <div class="cart"> <a class="btn btn-cart" title="Add to Cart"><span>Add
                                                            to Cart</span></a> <a class="btn btn-shopping"
                                                        title="Detail" href="product-detail.php"><span>Detail</span></a>
                                                </div>
                                                <div class="compare"><a class="action-button"
                                                        title="Compare this Product"><span>Compare this
                                                            Product</span></a>
                                                </div>
                                                <div class="wishlist"><a class="action-button"
                                                        title="Add to Wish List"><span>Add to Wish List</span></a>
                                                </div>
                                            </div>
                                        </div><!-- /.product-thumb -->
                                        <div class="product-thumb">
                                            <div class="image">
                                                <a class="" data-id="32" href="product-detail.php"><img
                                                        src="images/product/p22-81x81.jpg" alt="OxyELITE pro"
                                                        title="OxyELITE pro" />
                                                </a>
                                            </div>
                                            <div class="small_detail">
                                        ...
                                        <div class="product-thumb">
                                            <div class="image">
                                                <a class="" data-id="35" href="product-detail.php"><img
                                                        src="images/product/p12-81x81.jpg" alt="Emetrol"
                                                        title="Emetrol" />
                                                </a>
                                            </div>
                                            <div class="small_detail">
                                        ...
                                        <div class="product-thumb">
                                            <div class="image">
                                                <a class="" data-id="47" href="product-detail.php"><img
                                                        src="images/product/p21-81x81.jpg" alt="duodart"
                                                        title="duodart" />
                                                </a>
                                            </div>
                                            <div class="small_detail">
                                                ...
                                                <div class="rating"> <span class="fa fa-stack"><i
                                                        ...
                                                        class="fa fa-stack fa-hidden"><i
                                                            class="fa fa-star-o fa-stack-2x"></i></span> </div>
                                                <div class="price"> <span class="price-old">$122.00</span> <span
                                                        class="price-new">$104.00</span> </div>
                                                <div class="button-group">
                                                    <button class="btn-cart" type="button">Add to Cart</button>
                                                    <div class="wishlist-compare">
                                                        <button class="btn-wishlist" type="button"
        ...
        <div id="content" class="col-sm-12 col-md-9 col-lg-9">
            <div class="header_slider bannerslider-height nofloat mb-4 image-banner-height">
                <article class="boss_slider image-banner-height" style="max-width:870px;">
                        ...
                        <div class="tp-banner tp-banner0 image-banner-height">
                            <ul class="image-banner-height">
                                ...
                                <li class="image-banner-height" data-link="#" data-target="_self"
                                    data-transition="3dcurtain-horizontal" data-slotamount="7" data-masterspeed="500"
                                    data-saveperformance="on">
                                    <!-- MAIN IMAGE --><img
                                        src="{{$item->image_name!=''? asset('/assets/images/banner/').'/'.$item->image_name:''}}"
                                        alt="slidebg1"
                                        data-lazyload="{{$item->image_name!=''? asset('/assets/images/banner/').'/'.$item->image_name:''}}"
                                    ...
                                    <!-- LAYER NR. 5 -->
                                    <div class="tp-caption big_white sft customout rs-parallaxlevel-0" data-x="342"
                                        data-y="54"
                                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                        data-speed="400" data-start="500" data-end="5000" data-endspeed="400"
                                        data-easing="easeOutBack" data-endeasing="easeOutBack" data-elementdelay="0.1"
                                        data-endelementdelay="0.1" style="z-index: 2;"><img
                                            src="{{asset('/assets/client2/images/').'/dummy.png'}}" alt=""
                                            data-lazyload="{{asset('/assets/client2/images/slide/').'/line_caption.png'}}" />
                                    </div>
                                    <!-- LAYER NR. 6 -->
                                    <div class="tp-caption big_white sft customout rs-parallaxlevel-0" data-x="499"
                                        data-y="54"
                                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                        data-speed="400" data-start="500" data-end="5000" data-endspeed="400"
                                        data-easing="easeOutBack" data-endeasing="easeOutBack" data-elementdelay="0.1"
            ...
            <div class="bt-service mt-50">
                ...
                <div class="box-content">
                    <div class="row">
                        ...
                        <div class="bt-service-items col-sm-4 col-xs-12">
                            <div class="bt-service-content"> <a class="bt-service-icon" href="#"><i
                        ...
                        <div class="bt-service-items col-sm-4 col-xs-12">
                            <div class="bt-service-content">
                                <a class="bt-service-icon" href="#">
                                    <img src="{{asset('/assets/client2/images/bank_transfer.jpg')}}" style="width:80px;"
                                        alt="Bank Transfer">
                                </a>
